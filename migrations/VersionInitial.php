...
class VersionInitial extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->table->addColumn('cityId', Type::INTEGER, array('length' => 11, 'autoincrement' => true));
        ...
        $this->table->setPrimaryKey(array("cityId"));
        $userTable = $this->table;

        $this->table = $schema->createTable('roles');
        $this->table->addColumn('cityId', Type::INTEGER, array('autoincrement' => true));
        ...
        $this->table->addForeignKeyConstraint($userTable, array('user_id'), array('cityId'), array(), 'fk_user');
        $this->table->addForeignKeyConstraint($rolesTable, array('role_id'), array('cityId'), array(), 'fk_role');
        ...
        $this->table->addForeignKeyConstraint($mapTable, array('map_id'), array('cityId'), array(), 'fk_map');
        $this->table->addForeignKeyConstraint($tileTable, array('tile_id'), array('cityId'), array(), 'fk_tile');
        ...
        $this->table->setPrimaryKey(array('cityId', 'posX', 'posY'));
